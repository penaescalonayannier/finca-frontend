<!-- src/components/EditarTipoAnimal.vue -->
<template>
  <div class="editar-tipo-animal">
    <div class="formulario-contenedor">
      <h2>Editar Tipo de Animal</h2>
...
const cargarTipo = async () => {
  ...
  try {
    const tipo = await TipoAnimalService.getById(id)
    formulario.value = {
      codigo: tipo.codigo,
      nombre: tipo.nombre,
    ...
    console.error('Error al cargar tipo de animal:', error)
    mensaje.value = { texto: 'Error al cargar el tipo de animal', tipo: 'error' }
  } finally {
...
const guardarTipo = async () => {
  ...
  try {
    await TipoAnimalService.update(id, formulario.value)
    mensaje.value = { texto: 'Tipo de animal actualizado exitosamente', tipo: 'exito' }
    setTimeout(() => {
      router.push('/lista-tipo-animales')
    }, 1500)
  } catch (error) {
    console.error('Error al actualizar tipo de animal:', error)
    mensaje.value = { texto: 'Error al actualizar el tipo de animal', tipo: 'error' }
  } finally {
